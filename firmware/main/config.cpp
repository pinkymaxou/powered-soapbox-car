...
const ParamDesc PARAMS[] =
{
    ...
    {"pid_kp",          "Frein PID Kp",            PType::Float, 0.f,   0.100f, 2.f,    &KartConfig::pid_kp},
    {"pid_ki",          "Frein PID Ki",            PType::Float, 0.f,   0.050f, 5.f,    &KartConfig::pid_ki},
    {"pid_kd",          "Frein PID Kd",            PType::Float, 0.f,   0.003f, 1.f,    &KartConfig::pid_kd},
    {"vmax_kp",         "Limiteur PID Kp",         PType::Float, 0.f,   0.350f, 2.f,    &KartConfig::vmax_kp},
    {"vmax_ki",         "Limiteur PID Ki",         PType::Float, 0.f,   0.250f, 5.f,    &KartConfig::vmax_ki},
